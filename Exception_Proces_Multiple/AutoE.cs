...
namespace Exception_Proces_Multiple
{
    ...
    class AutoE
    {
        ...
        {
            // Dodano posebno za ovaj Exception_Proces_Multiple primjer.
            if(ubrzanje < 0)
            {
                throw new ArgumentOutOfRangeException("ubrzanje", "Brzina mora biti veća od nule!");
            }
            ...
            else
            {
                ...
                if(TrenutnaBrzina > MaksBrzina)
                {
                    ...
                    // Komentirano za ovaj primjer nepotrebno...
