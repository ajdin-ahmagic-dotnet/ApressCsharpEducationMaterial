...
namespace Events_01_AutoEvent
{
    class Auto
    {
        ...
        // Uveli smo AutoEventArgs Klasu pa onda delagat ovako izgleda:
        public delegate void AutoMotorHandler(object sender, AutoEventArgs e);

        // Sada radimo sa EVENTIMA - događaji.
        // Ovo su događaji za ovaj auto:
        public event AutoMotorHandler Prokuhao;
        public event AutoMotorHandler SamoStoNijeProkuhao;
        ...
        public void Ubrzanje(int ubrzaj)
        {
            ...
            if (pregrijan)
            {
                // I ovdje je došlo do prijena: uvedena je ključna riječ this, i new AutoEventArgs("pa onda poruka");
                if (Prokuhao != null)
                {
            ...
            else
            {
                ...
                if (10 == (MaximalnaBrzina - TrenutnaBrzina) && SamoStoNijeProkuhao != null)
                {
