...
namespace OOP_3
{
    class Auto
    {
        ...
        // Primjer "ima" koncepta.
        private Radio mojRadio = new Radio();


        // Delgat je taj koji pregovara između ove dvije
        // kalse i poziva objekt.
        public void UkljuciRadio(bool onOff)
        {
            mojRadio.Ukljuci(onOff);
        }
