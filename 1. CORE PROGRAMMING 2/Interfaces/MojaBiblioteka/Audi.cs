...
namespace MojaBiblioteka
{
    ...
    {
        // kalsa audi implementira IAuto Interface

        #region IAuto Members

        public void Kreni()
        {
            Console.WriteLine("Audi je krenuo! U staru smo!");
        }

        public void PritisniGas(double kolikoDuboko)
        {
            ...
            {
                Console.WriteLine("Gas audia ne može više  od 40%");
            }
            else
            {
        ...
        public void PritisniKocnicu(double pritisak)
        {
            if(pritisak == 10.0)
            {
